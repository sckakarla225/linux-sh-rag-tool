...
TARGET_COMMAND_SECTIONS = {
    ...
    "grep": [
        ...
        "THE BACKSLASH CHARACTER AND SPECIAL EXPRESSIONS", "REPETITION",
        "CONCATENATION", "ALTERNATION", "PRECEDENCE", "BACK-REFERENCES AND SUBEXPRESSIONS",
        "BASIC VS EXTENDED REGULAR EXPRESSIONS", "ENVIRONMENT", "EXAMPLES"
    ],
    "gawk": [
    ...
    "tar": [
        ...
        "HANDLING OF FILE ATTRIBUTES", "EXTENDED FILE ATTRIBUTES",
    ...
    "ss": [
        "NAME", "SYNOPSIS", "DESCRIPTION", "OPTIONS", "STATE-FILTER", "EXPRESSIONS", 
        "HOST SYNTAX", "EXAMPLES"
    ],
    "ping": [
    ...
    "nmap": [
        ...
        "MISCELLANEOUS OUTPUT OPTIONS", "VERBOSITY AND DEBUGGING OPTIONS"
    ],
    "nslookup": [
...
ADJACENT_SECTIONS = {
    ...
    "EXPRESSIONS": [
        ...
        "VARIABLES, RECORDS AND FIELDS OVERVIEW",
        "RECORDS",
        "FIELDS",
        "BUILT-IN VARIABLES",
        "ARRAYS",
        ...
        "ANCHORING INCLUDE/EXCLUDE RULES",
